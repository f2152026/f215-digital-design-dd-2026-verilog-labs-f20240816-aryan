...
module cla4(
  ...
  // Intermediate wires for AND terms in carry generation
  wire c1_1;
  wire c2_1, c2_2;
  wire c3_1, c3_2, c3_3;
  ...
  // c2 = g1 + p1.g0 + p1.p0.cin
  and #(2) (c2_1, p1, g0);
  and #(2) (c2_2, p1, p0, cin);
  or  #(2) (c2, g1, c2_1, c2_2);

  // c3 = g2 + p2.g1 + p2.p1.g0 + p2.p1.p0.cin
  and #(2) (c3_1, p2, g1);
  and #(2) (c3_2, p2, p1, g0);
  and #(2) (c3_3, p2, p1, p0, cin);
  or  #(2) (c3, g2, c3_1, c3_2, c3_3);

  // cout (c4) = g3 + p3.g2 + p3.p2.g1 + p3.p2.p1.g0 + p3.p2.p1.p0.cin
  and #(2) (c4_1, p3, g2);
  and #(2) (c4_2, p3, p2, g1);
  and #(2) (c4_3, p3, p2, p1, g0);
  and #(2) (c4_4, p3, p2, p1, p0, cin);
  or  #(2) (cout, g3, c4_1, c4_2, c4_3, c4_4);
